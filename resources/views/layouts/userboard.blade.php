...
<body>
    ...
    <div class="sidebar">
        <div class="admin-top">
            <div class="admin-profile d-flex py-5">
                <div class="admin-img mr-2">
                    <img src="http://127.0.0.1:8000/images/organizerimg.png" alt="logo" class="img-fluid rounded-circle">
                </div>
                <div class="admin-details">
                    <h5><strong>Shivam Ranabhat</strong></h5>
        ...
        <ul class="nav nav-tabs navbar-nav nav-links">
            ...
            <li>
                <a href="#bookings" data-toggle="tab" class="mt-2">
            ...
            <li>
                <a href="#set_points" data-toggle="tab" class="mt-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                      </svg>
                    <span class="links_name">Set Points</span>
                </a>
            </li>
            <li>
            ...
            <h6 class="ml-3 mt-5 text-uppercase text-muted account">Account</h6>
            <li>
