                ...
                <div class="bottom-area">
                    <div class="bottom">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="create-team-tab" data-toggle="tab" href="#create-team" role="tab" aria-controls="manage-team" aria-selected="true">Create Team</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="team-tab" data-toggle="tab" href="#team" role="tab" aria-controls="team" aria-selected="true">My Team</a>
                            </li>
                        </ul>
                    </div>
                </div>
