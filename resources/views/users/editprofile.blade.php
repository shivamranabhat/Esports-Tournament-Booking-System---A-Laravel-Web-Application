                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="participants-area dashboard-container">
                            ...
                            <form method="post" action="/profile/store" class="entry-form px-3"
                                    ...
                                    <div class="form-group form-outline col-md-6">
                                        ...
                                        <select name="game_id" id="game_id">
                                            ...
                                            @foreach ($games as $game)
                                                <option value="{{ $game->id }}" id="select">{{ $game->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('game_id')
                        ...
                        <div class="participants-area dashboard-container">
                            ...
                            <form method="post" action="/team/store" class="px-3" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-outline">
                                    ...
                                    <input class="form-control" placeholder="Enter your team name" type="text"
                                        id="name" name="name">
                                    @error('name')
                                        <p class="d-flex justify-content-start text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="form-row">
                                    <div class="form-group form-outline col-md-6">
                                        ...
                                        <input class="form-control" placeholder="Enter your player name" type="text"
                                            id="player_1" name="player_1">
                                        @error('player_1')
                                            <p class="d-flex justify-content-start text-danger mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="participants-single">
                                        ...
                                        <div class="right-area">
                                            <div class="nice-select"><span class="current single-item share">
                                                ...
                                                <ul class="list">
                                                    <li><a href="/team/edit/{{ $team->id }}"><i
                                                                class="fa-solid fa-pen-to-square"></i>Edit Information</a>
                                                    </li>
                                                    <li><a href="#" data-toggle="modal"
                                                            data-target="#delete_team"><i
                                                                class="fa-solid fa-trash"></i>Delete Team</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
