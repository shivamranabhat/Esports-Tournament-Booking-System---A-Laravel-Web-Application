                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="participants-area dashboard-container">
                                    <h4 class="py-3">Edit Tournament</h4>
                                    <form method="post" action="/tournament/update/{{$tournament->id}}" class="px-3" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-row">
                                            ...
                                            <div class="form-outline col-md-3">
                                                ...
                                                <input type="text" id="fees" name="fees" class="form-control" value="{{$tournament->fees}}"/>
                                                @error('fees')
                                                <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                                @enderror
                                            </div>
                                            <div class="form-outline col-md-4">
                                                ...
                                                <select name="type" id="type">
                                                    <option value="{{$tournament->type}}">{{$tournament->type}}</option>
                                        ...
                                        <div class="form-row">
                                            <div class="form-outline col-md-6 mb-4">
                                                ...
                                                <input type="datetime-local" class="form-control" id="closing_time" name="closing_time" value="{{$tournament->closing_time}}"/>
                                                @error('closing_time')
                                                <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                                @enderror
                                              </div>
                                              ...
                                              <div class="form-outline col-md-4 mb-4">
                                                ...
                                                <input type="number" id="team_size" name="team_size" class="form-control" value="{{$tournament->team_size}}"/>
                                                @error('team_size')
                                                <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                                @enderror
                                              </div>
                                              ...
                                              <input type="text" id="prize_pool" name="prize_pool" class="form-control" value="{{$tournament->prize_pool}}"/>
                                              @error('prize_pool')
                                              <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                              @enderror
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-outline col-md-6 mb-4">
                                              ...
                                              <input type="text" id="first_prize" name="first_prize" class="form-control" value="{{$tournament->first_prize}}"/>
                                              @error('first_prize')
                                              <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                              @enderror
                                            </div>
                                            <div class="form-outline col-md-4 mb-4">
                                              ...
                                              <input type="text" id="second_prize" name="second_prize" class="form-control" value="{{$tournament->second_prize}}"/>
                                              @error('second_prize')
                                              <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                              @enderror
                                            </div>
                                            <div class="form-outline col-md-2 mb-4">
                                              ...
                                              <input type="text" id="third_prize" name="third_prize" class="form-control"value="{{$tournament->third_prize}}"/>
                                              @error('third_prize')
                                              <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                              @enderror
                                            </div>
                                        ...
                                        <div class="form-outline mb-4">
                                          ...
                                          <textarea class="form-control bg-white text-dark" id="rules" name="rules" rows="4">{{$tournament->rules}}</textarea>
                                          @error('name')
                                          <p class="d-flex justify-content-start text-danger mt-2">{{$message}}</p>
                                          @enderror
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="update-btn btn text-white mb-3">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
